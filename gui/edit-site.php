                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="phpVersionSelect">
                                <option value="8.5" <?= ($site['php_version'] ?? '8.3') === '8.5' ? 'selected' : '' ?>>PHP 8.5 (Beta)</option>
                                <option value="8.4" <?= ($site['php_version'] ?? '8.3') === '8.4' ? 'selected' : '' ?>>PHP 8.4 (Latest, Recommended)</option>
                                <option value="8.3" <?= ($site['php_version'] ?? '8.3') === '8.3' ? 'selected' : '' ?>>PHP 8.3</option>
