                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="phpVersionSelect">
                                <option value="8.5" <?= ($site['php_version'] ?? '8.4') === '8.5' ? 'selected' : '' ?>>PHP 8.5 (Beta)</option>
                                <option value="8.4" <?= ($site['php_version'] ?? '8.4') === '8.4' ? 'selected' : '' ?>>PHP 8.4 (Latest, Recommended)</option>
                                <option value="8.3" <?= ($site['php_version'] ?? '8.4') === '8.3' ? 'selected' : '' ?>>PHP 8.3</option>
                                <option value="8.2" <?= ($site['php_version'] ?? '8.4') === '8.2' ? 'selected' : '' ?>>PHP 8.2</option>
                                <option value="8.1" <?= ($site['php_version'] ?? '8.4') === '8.1' ? 'selected' : '' ?>>PHP 8.1</option>
                                <option value="8.0" <?= ($site['php_version'] ?? '8.4') === '8.0' ? 'selected' : '' ?>>PHP 8.0</option>
                                <option value="7.4" <?= ($site['php_version'] ?? '8.4') === '7.4' ? 'selected' : '' ?>>PHP 7.4 (Legacy)</option>
                            </select>
                            <div class="form-text">
